...
- **v2.x (当前)** — Lexicon-driven completeness、38 个插件、LLM 强化 init、scope/phase filter、整条 DAG 上的 auto-repair。
- **v3.0 (规划中)** — 废弃 sprint 的 implement 流水线 (设计 → ImplStep → 代码，从 AI 流中移除人工项目管理层)。
