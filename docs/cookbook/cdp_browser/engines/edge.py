"""Edge CDP browser engine for the cookbook."""
...
@register_browser_engine("edge")
class EdgeBrowserEngine(BrowserEngine):
    """Resolve an Edge debug endpoint to a WebSocket debugger URL."""

    engine_name: ClassVar[str] = "edge"
