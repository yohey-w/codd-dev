"""Firefox CDP-compatible browser engine for the cookbook."""
...
@register_browser_engine("firefox")
class FirefoxBrowserEngine(BrowserEngine):
    """Resolve a CDP-compatible Firefox endpoint to a WebSocket debugger URL."""

    engine_name: ClassVar[str] = "firefox"
