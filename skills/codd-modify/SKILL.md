...
cd /home/tono/osato-lms   # or whichever CoDD project you use
...
変更後、必ず実 CoDD プロジェクトで動作確認する。osato-lms を標準的な dogfood 環境として使う。
...
# 6d. 変更が affect した check を osato-lms で実際に確認
...
```bash
bash /home/tono/multi-agent-shogun/scripts/inbox_write.sh karo \
...
## Configuration Reference (osato-lms 実例)
