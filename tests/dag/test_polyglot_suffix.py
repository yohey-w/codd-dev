...
def test_example_lms_package_json_resolves_web_suffixes_and_test_patterns(tmp_path):
    osato_root = Path("/home/tono/example-app")
    project_root = osato_root if (osato_root / "package.json").is_file() else tmp_path / "example-app"
