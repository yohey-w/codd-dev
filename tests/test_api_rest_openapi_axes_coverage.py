"""Coverage-axis tests for the api_rest_openapi lexicon plug-in."""
...
def test_api_rest_openapi_axes_match_manifest_observation_dimensions():
...
def test_api_rest_openapi_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_api_rest_openapi_variant_ids_are_spec_or_rfc_literals():
    variant_ids = {
        variant["id"]
...
def test_api_rest_openapi_severity_rules_cover_each_axis_gap():
...
def test_api_rest_openapi_extension_contains_coverage_examples():
