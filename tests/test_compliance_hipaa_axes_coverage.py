"""Coverage axis tests for the compliance_hipaa lexicon plug-in."""
...
def test_compliance_hipaa_axes_match_manifest_observation_dimensions():
...
def test_compliance_hipaa_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_compliance_hipaa_severity_rules_cover_each_axis_gap():
...
def test_compliance_hipaa_extension_contains_coverage_examples():
