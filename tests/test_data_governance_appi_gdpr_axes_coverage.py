"""Coverage axis tests for the data_governance_appi_gdpr lexicon plug-in."""
...
def test_data_governance_appi_gdpr_axes_match_manifest_observation_dimensions():
...
def test_data_governance_appi_gdpr_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_data_governance_appi_gdpr_severity_rules_cover_each_axis_gap():
...
def test_data_governance_appi_gdpr_extension_contains_coverage_examples():
