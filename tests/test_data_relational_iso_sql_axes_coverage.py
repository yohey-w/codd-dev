"""Coverage-axis tests for the data_relational_iso_sql lexicon plug-in."""
...
def test_data_relational_iso_sql_axes_match_manifest_observation_dimensions():
...
def test_data_relational_iso_sql_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_data_relational_iso_sql_variant_ids_are_standard_sql_literals():
    variant_ids = {
        variant["id"]
...
def test_data_relational_iso_sql_severity_rules_cover_each_axis_gap():
...
def test_data_relational_iso_sql_extension_contains_coverage_examples():
