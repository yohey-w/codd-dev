"""Coverage axis tests for the mobile_android_material3 lexicon plug-in."""
...
def test_mobile_android_material3_axes_match_manifest_observation_dimensions():
...
def test_mobile_android_material3_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_mobile_android_material3_severity_rules_cover_each_axis_gap():
...
def test_mobile_android_material3_extension_contains_coverage_examples():
