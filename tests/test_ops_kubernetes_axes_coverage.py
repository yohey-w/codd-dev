"""Coverage-axis tests for the ops_kubernetes lexicon plug-in."""
...
def test_ops_kubernetes_axes_match_manifest_observation_dimensions():
...
def test_ops_kubernetes_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_ops_kubernetes_variant_ids_are_kubernetes_literals():
    variant_ids = {
        variant["id"]
...
def test_ops_kubernetes_severity_rules_cover_each_axis_gap():
...
def test_ops_kubernetes_extension_contains_coverage_examples():
