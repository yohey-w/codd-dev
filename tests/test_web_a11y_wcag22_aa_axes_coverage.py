"""Coverage axis tests for the web_a11y_wcag22_aa lexicon plug-in."""
...
def test_web_a11y_wcag22_aa_axes_match_manifest_observation_dimensions():
...
def test_web_a11y_wcag22_aa_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_web_a11y_wcag22_aa_severity_rules_cover_each_axis_gap():
...
def test_web_a11y_wcag22_aa_extension_contains_coverage_examples():
