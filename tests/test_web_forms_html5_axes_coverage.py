"""Coverage-axis tests for the web_forms_html5 lexicon plug-in."""
...
def test_web_forms_html5_axes_match_manifest_observation_dimensions():
...
def test_web_forms_html5_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_web_forms_html5_variant_ids_are_spec_literals():
    variant_ids = {
        variant["id"]
...
def test_web_forms_html5_severity_rules_cover_each_axis_gap():
...
def test_web_forms_html5_extension_contains_coverage_examples():
