"""Coverage-axis tests for the web_performance_core_web_vitals lexicon plug-in."""
...
def test_web_performance_core_web_vitals_axes_match_manifest_observation_dimensions():
...
def test_web_performance_core_web_vitals_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_web_performance_core_web_vitals_variant_ids_are_source_metric_literals():
    variant_ids = {
        variant["id"]
...
def test_web_performance_core_web_vitals_severity_rules_cover_each_axis_gap():
...
def test_web_performance_core_web_vitals_extension_contains_coverage_examples():
