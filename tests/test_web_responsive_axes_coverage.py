"""Coverage axis tests for the web_responsive lexicon plug-in."""
...
def test_web_responsive_axes_match_manifest_observation_dimensions():
...
def test_web_responsive_axes_have_rationale_criticality_and_variants():
    axes = _yaml("lexicon.yaml")["coverage_axes"]
...
def test_web_responsive_severity_rules_cover_each_axis_gap():
...
def test_web_responsive_extension_contains_coverage_examples():
